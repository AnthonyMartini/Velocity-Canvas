(()=>{var e={};e.id=435,e.ids=[435],e.modules={10846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},44870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},29294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},63033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},31973:(e,t,o)=>{"use strict";o.r(t),o.d(t,{patchFetch:()=>m,routeModule:()=>d,serverHooks:()=>h,workAsyncStorage:()=>p,workUnitAsyncStorage:()=>c});var r={};o.r(r),o.d(r,{POST:()=>u});var a=o(42706),n=o(28203),i=o(45994),s=o(39187),l=o(86313);async function u(e){try{let{prompt:t}=await e.json();if(!t)return s.NextResponse.json({error:"Prompt is required"},{status:400});let o=await l.ge.generateContent(t),r=o.response.text().replace(/^```[a-zA-Z]*\n?/,"").replace(/\n?```$/,"").trim();return s.NextResponse.json({yaml_code:r,usage:o.response.usageMetadata})}catch(e){return console.error("Gemini API error:",e),s.NextResponse.json({error:e.message},{status:500})}}let d=new a.AppRouteRouteModule({definition:{kind:n.RouteKind.APP_ROUTE,page:"/api/generate/route",pathname:"/api/generate",filename:"route",bundlePath:"app/api/generate/route"},resolvedPagePath:"C:\\Users\\antho\\Documents\\AntiGravity\\Velocity Canvas\\src\\app\\api\\generate\\route.tsx",nextConfigOutput:"",userland:r}),{workAsyncStorage:p,workUnitAsyncStorage:c,serverHooks:h}=d;function m(){return(0,i.patchFetch)({workAsyncStorage:p,workUnitAsyncStorage:c})}},96487:()=>{},78335:()=>{},86313:(e,t,o)=>{"use strict";o.d(t,{ge:()=>l,DF:()=>d,Q3:()=>u});var r=o(36858);let a=`
...
- Output raw JSON only — NO markdown fences.
`,s=new r.ij(process.env.GEMINI_API_KEY||""),l=s.getGenerativeModel({model:"gemini-3.1-flash-lite-preview",systemInstruction:a}),u=s.getGenerativeModel({model:"gemini-3.1-flash-lite-preview",systemInstruction:n}),d=s.getGenerativeModel({model:"gemini-3.1-flash-lite-preview",systemInstruction:i})}};var t=require("../../../webpack-runtime.js");t.C(e);var o=e=>t(t.s=e),r=t.X(0,[989,559],()=>o(31973));module.exports=r})();