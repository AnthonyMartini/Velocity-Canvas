(()=>{var e={};e.id=198,e.ids=[198],e.modules={10846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},44870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},29294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},63033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},46217:(e,t,o)=>{"use strict";o.r(t),o.d(t,{patchFetch:()=>m,routeModule:()=>d,serverHooks:()=>c,workAsyncStorage:()=>p,workUnitAsyncStorage:()=>h});var r={};o.r(r),o.d(r,{POST:()=>u});var n=o(42706),a=o(28203),i=o(45994),s=o(39187),l=o(86313);async function u(e){try{let{message:t,canvas_components:o,canvas_width:r,canvas_height:n,image_data:a,image_mime_type:i,chat_history:u}=await e.json();if(!t)return s.NextResponse.json({error:"Message is required"},{status:400});let d=`Canvas size: ${r} x ${n} px.
`;if(o&&o.length>0){let e=[],t=(o,r="")=>{let n=`${r}- ID: "${o.id}", Type: "${o.type}", x=${o.x||0}, y=${o.y||0}, w=${o.width||0}, h=${o.height||0}`;o.text&&(n+=`, text="${o.text}"`),o.name&&(n+=`, name="${o.name}"`),e.push(n),o.children&&o.children.forEach(e=>t(e,r+"  "))};o.forEach(e=>t(e)),d+="Current components on canvas:\n"+e.join("\n")}else d+="The canvas is currently empty.";let p=`${d}

User prompt: ${t.trim()}`,h=u.map(e=>({role:"user"===e.role?"user":"model",parts:[{text:e.content}]})),c=(await l.DF.generateContent({contents:[...h,{role:"user",parts:[{text:p},...a?[{inlineData:{data:a,mimeType:i}}]:[]]}],generationConfig:{responseMimeType:"application/json"}})).response.text();return s.NextResponse.json(JSON.parse(c))}catch(e){return console.error("Gemini API error:",e),s.NextResponse.json({error:e.message},{status:500})}}let d=new n.AppRouteRouteModule({definition:{kind:a.RouteKind.APP_ROUTE,page:"/api/renderer-chat/route",pathname:"/api/renderer-chat",filename:"route",bundlePath:"app/api/renderer-chat/route"},resolvedPagePath:"C:\\Users\\antho\\Documents\\AntiGravity\\Velocity Canvas\\src\\app\\api\\renderer-chat\\route.tsx",nextConfigOutput:"",userland:r}),{workAsyncStorage:p,workUnitAsyncStorage:h,serverHooks:c}=d;function m(){return(0,i.patchFetch)({workAsyncStorage:p,workUnitAsyncStorage:h})}},96487:()=>{},78335:()=>{},86313:(e,t,o)=>{"use strict";o.d(t,{ge:()=>l,DF:()=>d,Q3:()=>u});var r=o(36858);let n=`
