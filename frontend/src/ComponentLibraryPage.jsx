...
const SCHEMAS = [buttonSchema, labelSchema, textInputSchema, dropdownSchema, containerSchema]
        ...
        <div className="flex flex-col gap-8">
          {SCHEMAS.map(schema => (
            <div key={schema.type} className="bg-surface/50 border border-overlay/30 rounded-2xl overflow-hidden shadow-sm">
              ...
              {/* Card Header */}
              <div className="px-6 py-5 border-b border-overlay/20 flex items-start justify-between bg-surface/80">
