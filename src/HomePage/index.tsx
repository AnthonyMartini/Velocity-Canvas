      ...
      <div className="max-w-5xl mx-auto w-full flex flex-col gap-12">
        ...
        <section className="animate-slide-up flex flex-wrap gap-4">
          ...
          <button
            ...
            className="flex items-center gap-3 bg-surface border border-overlay/40 hover:bg-surface/80 hover:border-overlay/60 text-white px-6 py-4 rounded-2xl font-bold transition-all group"
          >
            <div className="w-10 h-10 bg-overlay/30 rounded-full flex items-center justify-center text-subtext group-hover:text-white transition-colors shrink-0">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <section className="animate-slide-up" style={{ animationDelay: '100ms' }}>
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-white">Continue Working</h2>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {recentProjects.map((proj: any) => (
                ...
                >
                  ...
                  <h3 className="text-lg font-bold text-white leading-tight truncate mb-2 group-hover:text-accent transition-colors">
