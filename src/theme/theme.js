...
export const appTheme = {
  ...
  controlDefaults: {
    Button: {
      ...
      DisabledFill: '#2a2d2e',
      Fill: '#0e639c',
      FocusedBorderColor: '#1177bb',
      HoverBorderColor: '#1177bb',
      HoverColor: '#ffffff',
      HoverFill: '#1177bb',
      PressedBorderColor: '#094771',
      PressedColor: '#ffffff',
      PressedFill: '#094771',
    },
    Checkbox: {
      BorderColor: '#3c3c3c',
      CheckboxBackgroundFill: '#0e639c',
      CheckboxBorderColor: '#0e639c',
    ...
    Dropdown: {
      ...
      HoverColor: '#d4d4d4',
      HoverFill: '#333333',
      PressedBorderColor: '#0e639c',
      PressedColor: '#d4d4d4',
      PressedFill: '#252526',
      SelectionColor: '#ffffff',
      SelectionFill: '#0e639c',
    },
    Gallery: {
